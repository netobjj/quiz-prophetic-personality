                ...
                <Row className='question justify-start xl:ms-[200px]'>
                    <Col>
                        <Row className="content">
                            ...
                            <Col>
                                <p className='text-lg'>{arrayQuestions[currentIndexQuestion].content}</p>
                        ...
                        <Row className='options m-4'>
                            ...
                            >
                                <Radio.Button
                                    type='primary'
                                    value={true}
                                    onClick={() => handleAnswerClick(arrayQuestions[currentIndexQuestion].category, true)}>
                                    Sim
                                </Radio.Button>
                                <Radio.Button
                                    type='primary'
                                    value={false}
                                    onClick={() => handleAnswerClick(arrayQuestions[currentIndexQuestion].category, false)}>
                                    Não
                                </Radio.Button>
                            </Radio.Group>
                        </Row>
